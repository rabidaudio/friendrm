...
export default class Friend {
  ...
  constructor (data: {name: string, avatar: string, contacts: Contact[]}) {
    this.name = data.name
...
export const sortByChannel = (channel: ?Channel) => (a: Friend, b: Friend): number => {
  return (b.daysSinceLastContact(channel) || Infinity) -
